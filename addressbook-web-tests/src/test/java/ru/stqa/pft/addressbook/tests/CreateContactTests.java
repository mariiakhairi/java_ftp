...
public class CreateContactTests {
  ...
  public void testCreateContact() throws Exception {
    ...
    fillContactForm(new ContactData("Mariia", "Khairi", "QA", "Oracle", "IMPZ,LagoVista A", "0559470842", "mariia_khairi@inbox.com", "9", "May", "1989"));
    submitContactForm();
    gotoHomePage();
    logout();
  }
  ...
  private void fillContactForm(ContactData contactData) {
    ...
    wd.findElement(By.name("title")).sendKeys(contactData.getPosition());
